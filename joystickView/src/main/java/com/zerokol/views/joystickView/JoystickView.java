...
public class JoystickView extends View implements Runnable {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawOval((float) (centerX - joystickRadius*0.3), (float) (centerY - joystickRadius), (float) (centerX + joystickRadius*0.3),
                (float) (centerY + joystickRadius), mainCircle);
       ...
       /* canvas.drawCircle((int) centerX, (int) centerY, joystickRadius,
        ...
        canvas.drawOval((float) (centerX - joystickRadius*0.25), (float) (centerY - joystickRadius*0.4),
                (float) (centerX + joystickRadius*0.25), (float) (centerY + joystickRadius*0.4), secondaryCircle);
        // paint lines
