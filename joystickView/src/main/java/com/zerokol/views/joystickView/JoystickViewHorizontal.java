...
public class JoystickViewHorizontal extends View implements Runnable {
    // Constants
    ...
    public JoystickViewHorizontal(Context context) {
        super(context);
    }

    public JoystickViewHorizontal(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJoystickView();
    }

    public JoystickViewHorizontal(Context context, AttributeSet attrs, int defaultStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawOval((float) (centerX - joystickRadius), (float) (centerY - joystickRadius*0.3), (float) (centerX + joystickRadius),
                (float) (centerY + joystickRadius*0.3), mainCircle);
       ...
       /* canvas.drawCircle((int) centerX, (int) centerY, joystickRadius,
        ...
        canvas.drawOval((float) (centerX - joystickRadius*0.4), (float) (centerY - joystickRadius*0.25),
                (float) (centerX + joystickRadius*0.4), (float) (centerY + joystickRadius*0.25), secondaryCircle);
        // paint lines
        ...
        canvas.drawCircle(xPosition, yPosition, (float) (buttonRadius*0.45), button);
    }
